...
namespace Shards
{
    ...
    internal class ShardPlateMissionBehaviour : MissionView
    {
        ...
        public void ShardKillNonPlate(Agent victim, Blow blow) {
            ...
            victim.AgentVisuals.CreateParticleSystemAttachedToBone("storm_light_hit", (sbyte) HumanBone.Head, ref frame);
            // TODO: Play sound of shardblade slicing / burning soul
